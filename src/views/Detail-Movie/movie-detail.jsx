...
const CardSimilar = lazy(() => import("../Componenst/cards.jsx"));
    ...
    <div className="bg-gray-200 ">
      <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8  ">
          ...
          <div className="details ">
            ...
            <div className="table-details flex justify-start">
              <table className="table-auto">
                <tbody>
                  <tr>
                    <td className="row-span-2 row-start-1 col-span-2 col-start-1 col-end-2 border-0 border-white px-3 text-gray-800 pt-3 pb-5 title">
                      {details.title}{" "}
                    </td>
        ...
        <div className="similar-movie mt-6">
          <h1
            className="text-synopsis text-gray-800"
